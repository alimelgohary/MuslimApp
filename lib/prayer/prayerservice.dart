...
class PrayerService {
  Future<List<PrayerModel>> getList(String city, int method) async {
    ...
    String request =
        'http://api.aladhan.com/v1/calendar?latitude=${location[0]}&longitude=${location[1]}&method=$method&month=${date[1]}&year=${date[2]}';
